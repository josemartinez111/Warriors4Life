...
<template>
  ...
  <span class="text-rose-600 text-base sm:text-lg md:text-xl">
    empowering our nation’s heroes</span> to embrace life beyond the battlefield. The road may be long,
  <span class="text-blue-400 text-base sm:text-lg md:text-xl">but together we ride toward brighter futures</span>,
  offering unwavering support and strength to every warrior we serve.<span class="text-blue-300 text-base sm:text-lg md:text-xl">
  Join us as we continue to redefine what's possible for those who have given so much.</span>
</p>
...
.support-us {
  @apply btn-ghost btn bg-rose-600 text-white desktop:py-4
  desktop:px-24 rounded-[8px] hover:bg-blue-950 duration-150;
}
